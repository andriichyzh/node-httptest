...
HttpTest.prototype.setBody = function(body) {
    ...
    if (typeof body === 'string') {
        ...
        if (this.option.current) {
            this.option.current.form = this.option.current.form || {};
            this.option.current.form = ld.extend(this.option.current.form, body);
        } else {
            this.option.common.form = this.option.common.form || {};
            this.option.common.form = ld.extend(this.option.common.form, body);
        }
    }
...
HttpTest.prototype.end = function(callback) {
    ...
    if (this.option.current.form) {
        options.form = ld.defaults(this.option.current.form, this.option.common.form);
